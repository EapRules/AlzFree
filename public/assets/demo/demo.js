index = {
  ...
  initLandingPageChart: function() {
    ...
    var chartBig = new Chart(ctx, {
      ...
      responsive: true,
      data: {
        labels: ["Lunes 01", "Martes 02", "Miercoles 03", "Jueves 04", "Viernes 05", "sabado 06", "Domingo 07", "Lunes 08", "Martes 09", "Miercoles 10", "Jueves 11", "Viernes 12", "sabado 13", "Domingo 14"],
        datasets: [{
          label: "Alimentacion",
          fill: true,
          backgroundColor: gradientFill,
          ...
          pointRadius: 4,
          data: [250, 330, 300, 400, 290, 290, 350, 250, 400, 300, 370, 290, 290, 250]
        }]
      },
      options: {
        maintainAspectRatio: false,
